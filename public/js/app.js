...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lrz__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lrz___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lrz__);
...
$.extend({
     ...
     * 滚动固定
     */
    scrollFixed: function scrollFixed(ele) {
     ...
     * @param {*} source 来源
     */
    pasteUploadImage: function pasteUploadImage(event, editorElement) {
        var source = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'articles';
        ...
        if (clipboardData) {
            ...
            if (item && item.kind === 'file' && item.type.match(/^image\//i)) {
                ...
                reader.onload = function () {
                    //前端压缩
                    __WEBPACK_IMPORTED_MODULE_0_lrz___default()(reader.result, { width: 1080 }).then(function (res) {
                        $.ajax({
