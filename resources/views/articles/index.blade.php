                    ...
                    <table class="table table-condensed table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Title</th> <th>Content</th> <th>User_id</th> <th>Subject_id</th> <th>Reply_count</th> <th>View_count</th> <th>Order</th> <th>Excerpt</th> <th>Slug</th>
                        ...
                        <tbody>
                            @foreach($articles as $article)
                                <tr>
                                    ...
                                    <td>{{$article->title}}</td> <td>{{$article->content}}</td> <td>{{$article->user_id}}</td> <td>{{$article->subject_id}}</td> <td>{{$article->reply_count}}</td> <td>{{$article->view_count}}</td> <td>{{$article->order}}</td> <td>{{$article->excerpt}}</td> <td>{{$article->slug}}</td>
